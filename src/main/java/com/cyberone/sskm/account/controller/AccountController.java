package com.cyberone.sskm.account.controller;
...
public class AccountController {
    ...
    /**
     * 접근권한그룹의 계정그룹 조회 - SelectBox 적용
     */
    @RequestMapping("/account/selectView")
    public void selectView(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
