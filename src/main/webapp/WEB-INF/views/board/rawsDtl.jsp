...
<form name="tx_editor_form" id="tx_editor_form" action="/rawsReg" method="post" enctype="multipart/form-data">
    ...
    <div class="tableBtnBox">
        ...
        <a href="/raws?page=<%=nPage %>&searchWord=<%=sSearchWord %>">
            취소
        </a>
    </div>

<form name="delForm" method="post" action="/rawsDel" onsubmit="return delSubmit();">
    <input type="hidden" name="bbs" value="<%=StringUtil.convertString(mapDetail.get("bbsId"))%>">
</form>    
