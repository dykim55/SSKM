...
<form name="tx_editor_form" id="tx_editor_form" action="/securityTrendReg" method="post" enctype="multipart/form-data">
    ...
    <div class="tableBtnBox">
        ...
        <a href="/securityTrend?page=<%=nPage %>&searchWord=<%=sSearchWord %>">
            취소
        </a>
    </div>

<form name="delForm" method="post" action="/securityTrendDel" onsubmit="return delSubmit();">
    <input type="hidden" name="bbs" value="<%=StringUtil.convertString(mapDetail.get("bbsId"))%>">
</form>    
